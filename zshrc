...
__conda_setup="$('/home/bill/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/bill/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/bill/anaconda3/etc/profile.d/conda.sh"
    else
